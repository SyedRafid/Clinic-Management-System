...
if (isset($_POST['submit'])) {
	...
	$query = "INSERT INTO users (fullname, address, city, gender, email, password, userType) VALUES (?, ?, ?, ?, ?, ?, ?)";
	$stmt = mysqli_prepare($con, $query);

	mysqli_stmt_bind_param($stmt, "sssssss", $fname, $address, $city, $gender, $email, $password, $userType);
