...
if($sql)
{
$sql2=mysqli_query($con,"Update doctors set specilization='$docspecialization', contactno='$doccontactno' where id='".$_SESSION['id']."'");
if($sql2)
{
                                                    ...
                                                    <form role="form" name="edit" method="post">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="gender" class="form-control"
                                                                required="required">
                                                                <option
                                                                    value="<?php echo htmlentities($data['gender']);?>">
