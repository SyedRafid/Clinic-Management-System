...
$docstatus=1;
$action=1;
$query=mysqli_query($con,"insert into appointment(doctorSpecialization,doctorId,userId,consultancyFees,appointmentDate,appointmentTime,userStatus,doctorStatus,Pcontact,age,medicalHistory,action) values('$specilization','$doctorid','$userid','$fees','$appdate','$time','$userstatus','$docstatus','$pnum','$ptage','$medhis', '$action')");
	if($query)
	{
...
?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="ptage" required="required">
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="pnum" required="required">
                                                    </div>
