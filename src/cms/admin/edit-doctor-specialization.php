...
if(isset($_POST['submit']))
{
	...
	if ($sql=mysqli_query($con,"update  doctorSpecilization set specilization='$docspecialization' where id='$id'"))
	{
		echo "<script>alert('Doctor Specialization updated successfully !!');</script>";
