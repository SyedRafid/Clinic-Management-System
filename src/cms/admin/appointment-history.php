                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <table class="table table-hover" id="sample-table-1">
                                    ...
                                    <tbody>
                                        <?php
                                          $sql = mysqli_query($con, "SELECT appointment.*, doctors.*, doctor_users.fullName AS doctor_name, IF(appointment.userId is NULL, tblpatient.PatientName, patient_users.fullName) AS patient_name
                                          FROM appointment
                                          JOIN doctors ON doctors.id = appointment.doctorId
                                          JOIN users AS doctor_users ON doctors.id = doctor_users.id
                                          LEFT JOIN users AS patient_users ON appointment.userId = patient_users.id
                                        ...
                                        <tr>
                                            ...
                                            <td class="hidden-xs"><?php echo $row['doctor_name']; ?></td>
                                            ...
                                            <td>
                                                <div class="visible-md visible-lg hidden-sm hidden-xs">
                                                    <?php if (($row['userStatus'] == 1) && ($row['doctorStatus'] == 1) && ($row['action'] == 1)) {
                                                                ...
                                                                echo "No Action yet";
                                                            } else if (($row['userStatus'] == 1) && ($row['doctorStatus'] == 1) && ($row['action'] != 1)) {
