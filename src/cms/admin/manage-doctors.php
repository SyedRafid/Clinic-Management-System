...
if (strlen($_SESSION['id']) == 0) {
    ...
    if (isset($_GET['del'])) {
        ...
        $deleteDoctorSql = mysqli_query($con, "DELETE FROM doctors WHERE id ='$docid'");
        
        if ($deleteDoctorSql) {
            $deleteUserSql = mysqli_query($con, "DELETE FROM users WHERE id ='$docid'");
            
            if ($deleteUserSql) {
                $_SESSION['msg'] = "Doctor data and associated user data deleted successfully!";
            } else {
                $_SESSION['error'] = "Error deleting user data: " . mysqli_error($con);
            }
        } else {
            $_SESSION['error'] = "Error deleting doctor data: " . mysqli_error($con);
        }
						...
						<div class="container-fluid container-fullw bg-white">
								...
								<?php echo htmlentities($_SESSION['msg']="");?></p>	
									<table class="table table-hover" id="sample-table-1">
										...
										<tbody>
<?php
$sql = mysqli_query($con, "SELECT doctors.*, users.fullName, users.regDate
FROM doctors
